...
public class OperationEndpoint {
	...
	public Response list(
		...
		try {
			list = operationDao.list(startPosition, maxResult);
		} catch (Exception e) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response create(Operation entity) throws IllegalArgumentException, UriBuilderException, JsonProcessingException {
    	...
    	try {
    		...
    		entity = operationDao.create(entity);
		...
		return Response.created(
		        UriBuilder.fromResource(OperationEndpoint.class)
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response update(@PathParam("id") long id, Operation entity) throws JsonProcessingException{
     ...
     */
    private void validate(Operation entity) throws ConstraintViolationException {
        // Create a bean validator and check for issues.
        Set<ConstraintViolation<Operation>> violations = validator.validate(entity);
